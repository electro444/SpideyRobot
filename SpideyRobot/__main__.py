...
SPIDEY_IMG = "https://telegra.ph/file/f65cb56e8a7f3f184962b.jpg"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            SPIDEY_IMG, caption= "Hᴇʏ, Scorbunny Is Hᴇʀᴇ,CHECK ME OUT  GOIN OUR CHANNELS FOR MORE INFO: <code>{}</code>".format(
                uptime
            ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="👥🅂🅄🄿🄿🄾🅁🅃", url="https://t.me/trainer_zone")
                  ],
                  [
                  InlineKeyboardButton(text="📝ⓁⓄⒼⓈ", url="https://t.me/Scorbunny_logs")
                  ],
                  [
                  InlineKeyboardButton(text="PIGASUS_SUPPORT", url="https://t.me/PigasusSupport")
                  ]
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "〚SCORBUNNY IS RUNNING WITH RAGING FIRE [🔥](https://telegra.ph/file/0e8cfb4eae34139fd3568.mp4)〛")
        except Unauthorized:
            LOGGER.warning(
